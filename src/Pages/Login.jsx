        ...
        <section className='body-font font-poppins w-screen h-full bg-primary'>
            ...
            <div className='flex pl-24 pr-24 pb-24 mt-32'>
              <div className='mt-8 w-full h-auto bg-white rounded-l-3xl shadow-2xl shadow-silver-500 pb-52'>
                ...
                <input type="text" id="name" className="bg-gray-50 border border-gray-600 text-gray-900 text-lg ml-32 rounded-lg focus:ring-black-500 focus:border-black-500 block w-4/6 px-6 py-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Your Name" required></input>
                <label for="password" class="block mb-2 text-lg font-medium text-black text-left mt-4 ml-32">Pasword</label>
                <input type="password" id="password" class="bg-gray-50 border border-gray-600 text-gray-900 text-lg ml-32 rounded-lg focus:ring-black-500 focus:border-black-500 block w-4/6 px-6 py-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white " placeholder="•••••••••" required/>
